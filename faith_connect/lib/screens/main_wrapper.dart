...
class _MainWrapperState extends State<MainWrapper> {
  ...
  /// Track last back button press for double-tap-to-exit feature.
          ...
          children: [
            ...
            ListTile(
              leading: Container(
                ...
                child: Icon(Icons.video_library_rounded, color: Colors.purple[700]),
              ),
              title: const Text(
                'Create Reel',
                style: TextStyle(fontWeight: FontWeight.w600),
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        // Double-tap to exit: Show snackbar on first tap, exit on second tap within 2 seconds
